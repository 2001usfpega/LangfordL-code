...
public class MainDriver {
	...
	public static void main(String[] args) {
		...
		case 2:
			...
			User2.userLogin();
			System.out.println("If your login returns null, an invalid username or password was entered. Please try again.");
			...
			System.out.println("Enter 3 if you would like to make a withdrawal into an existing account.");
		...
		case 3:
			...
			System.out.println("Enter 5 if you would like to delete a user.");
